...
ARG SDK_TOOLS_FILE_URL=https://dl.google.com/android/repository/${ANDROID_SDK_TOOLS_FILE_NAME}

ENV BUILD_TOOLS='build-tools-25.0.2'
...
RUN apk add --no-cache wget bash \
    ...
    && cd ${ANDROID_HOME} \
    && wget --directory-prefix=${ANDROID_HOME} ${SDK_TOOLS_FILE_URL} \
