...
ARG MYSQL_CONNECTOR_PYTHON_FILE_NAME=mysql-connector-python-${MYSQL_CONNECTOR_PYTHON_VERSION}.tar.gz
...
ARG MYSQL_CONNECTOR_PYTHON_FILE_MD5=a17486b10d3624fe1227d720571f9e81
